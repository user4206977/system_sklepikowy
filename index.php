        ...
        <div class="card h-100 product-card shadow-sm border-0 bg-white">
            <div class="card-body p-4 text-center">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <span class="text-primary fw-bold fs-5"><?= number_format($p['price'], 2) ?> zł</span>
...
function addToCart(id, name, price, event) {
    ...
    // Zapamiętujemy pierwotne klasy, aby do nich wrócić
    ...
    icon.className = 'bi bi-check-lg'; // Ikona zatwierdzenia

    // Powrót do stanu pierwotnego po 800ms
    setTimeout(() => {
